...
//        0f, 0f
    ...
    init {
        ...
        val textureShader = OpenGLUtils.readRawTextFile(context, R.raw.gamma_frag)
        ...
        //不同的地方
        vGamma = GLES20.glGetUniformLocation(program, "gamma")
    }
    ...
    override fun onDrawFrame(textureId: Int): Int {
        ...
        //不同的地方 开始
        GLES20.glUniform1f(vGamma, gamma)
        //不同的地方 结束
